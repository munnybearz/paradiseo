...
#if !defined(__unix__) && !defined(_WINDOWS) && !(defined(__APPLE__) && defined(__MACH__))
...
#else //!defined(__unix__) && !defined(_WINDOWS) && !(defined(__APPLE__) && defined(__MACH__))
...
#endif //!defined(__unix__) && !defined(_WINDOWS) && !(defined(__APPLE__) && defined(__MACH__))
